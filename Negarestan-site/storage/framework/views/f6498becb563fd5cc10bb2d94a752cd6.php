    ...
    <div class="flex flex-col md:flex-row w-full max-w-4xl bg-white shadow-2xl rounded-2xl overflow-hidden m-8">
        ...
        <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <p class="text-center text-sm text-gray-500 mt-8">
                ...
                <a href="<?php echo e(route('login')); ?>" class="font-bold text-[var(--brand-blue)] hover:underline">ورود به حساب کاربری</a>
            </p>
        </div>
...
<?php /**PATH D:\programming projects\laravel\negarestan\resources\views/panel/forgot_password.blade.php ENDPATH**/ ?>