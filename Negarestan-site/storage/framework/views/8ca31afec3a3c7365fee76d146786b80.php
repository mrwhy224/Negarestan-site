...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h1 class="text-3xl font-bold text-[var(--brand-blue)]">مشاهده  گزینه ها - آزمون <?php echo e($quiz->title); ?></h1>
                            <nav class="text-sm font-semibold mt-2" aria-label="Breadcrumb">
                                <ol class="list-none p-0 inline-flex">
                                    ...
                                    <li class="mx-2 text-gray-400">/</li>
                                    <li class="flex items-center">
                                        <a href="<?php echo e(route('quiz.question',['quiz'=>$quiz->id])); ?>" class="text-gray-500 hover:text-gray-700">سوالات</a>
                                    </li>
                                    <li class="mx-2 text-gray-400">/</li>
                        ...
                        <table class="w-full whitespace-nowrap">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="p-4"><?php echo e($option->id); ?></td>
                                        <td class="p-4"><?php echo e($question->text); ?></td>
                                        <td class="p-4"><?php echo e($option->text); ?></td>
                                    </tr>
