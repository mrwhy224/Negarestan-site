...
<body class="bg-gray-100">
    ...
    <div x-data="{ sidebarOpen: true }" class="flex h-screen bg-gray-200">
        ...
        <aside 
            ...
            <nav class="mt-4 px-4" x-data="{ openMenu: '<?php echo e(request()->routeIs('post.*') ? 'post' : (request()->routeIs('quiz.*') ? 'quiz' : '')); ?>' }">
                <a href="<?php echo e(route('dashboards')); ?>" class="flex items-center px-4 py-2.5 rounded-lg <?php echo e(request()->routeIs('dashboards') ? 'text-gray-200 bg-[var(--brand-blue-light)]' : 'text-gray-300 hover:bg-[var(--brand-blue-light)]'); ?>">
                ...
                <div class="mt-4">
                    ...
                    <div x-show="openMenu === 'post'" x-cloak class="mt-2 mr-6 space-y-2 border-r-2 border-gray-500 pr-4">
                        <a href="<?php echo e(route('post.list')); ?>" class="block py-2 text-gray-400 <?php echo e(request()->routeIs('post.list') ? 'text-white' : 'hover:text-white'); ?>">همه نوشته ها</a>
                        <a href="<?php echo e(route('post.category')); ?>" class="block py-2 text-gray-400 <?php echo e(request()->routeIs('post.category') ? 'text-white' : 'hover:text-white'); ?>">دسته بندی</a>
                        <a href="<?php echo e(route('post.create')); ?>" class="block py-2 text-gray-400 <?php echo e(request()->routeIs('post.create') ? 'text-white' : 'hover:text-white'); ?>">افزودن</a>
                    </div>
                </div>
                <div class="mt-4">
                    ...
                    <div x-show="openMenu === 'quiz'" x-cloak class="mt-2 mr-6 space-y-2 border-r-2 border-gray-500 pr-4">
                        <a href="<?php echo e(route('quiz.list')); ?>" class="block py-2 text-gray-400 <?php echo e(request()->routeIs('quiz.list') ? 'text-white' : 'hover:text-white'); ?>">لیست</a>
                        <a href="<?php echo e(route('quiz.result')); ?>" class="block py-2 text-gray-400 <?php echo e(request()->routeIs('quiz.result') ? 'text-white' : 'hover:text-white'); ?>">نتایج</a>
                    </div>
                </div>

                <a href="<?php echo e(route('admin')); ?>" class="flex items-center mt-4 px-4 py-2.5 rounded-lg <?php echo e(request()->routeIs('admin') ? 'text-gray-200 bg-[var(--brand-blue-light)]' : 'text-gray-300 hover:bg-[var(--brand-blue-light)]'); ?>">
                    <i class="fas fa-file-alt w-6 text-center text-lg"></i>
                    <span class="mr-3">مدیران</span>
                </a>
                <a href="<?php echo e(route('post.category')); ?>" class="flex items-center mt-4 px-4 py-2.5 rounded-lg <?php echo e(request()->routeIs('post.category') ? 'text-gray-200 bg-[var(--brand-blue-light)]' : 'text-gray-300 hover:bg-[var(--brand-blue-light)]'); ?>">
                    <i class="fas fa-file-alt w-6 text-center text-lg"></i>
...
<?php /**PATH D:\programming projects\laravel\negarestan\resources\views/panel/layout.blade.php ENDPATH**/ ?>