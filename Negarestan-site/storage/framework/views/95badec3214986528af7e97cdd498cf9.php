    ...
    <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
      ...
      <form id="login-form" action="#" class="space-y-6" novalidate>
        ...
        <div class="flex items-center justify-between text-sm">
          <a href="<?php echo e(route('forgot_password')); ?>" class="font-semibold text-gray-500 hover:text-[var(--brand-blue)] transition">فراموشی رمز عبور</a>
        </div>
      ...
      <p class="text-center text-sm text-gray-500 mt-8">
        حساب کاربری ندارید؟
        <a href="<?php echo e(route('register')); ?>" class="font-bold text-[var(--brand-blue)] hover:underline">ثبت نام کنید</a>
      </p>
    </div>
...
<?php /**PATH D:\programming projects\laravel\negarestan\resources\views/panel/login.blade.php ENDPATH**/ ?>