    ...
    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div class="flex items-center gap-10">
            ...
            <nav class="hidden md:flex space-x-8 space-x-reverse">
                <a href="<?php echo e(route('dashboards')); ?>" class="text-gray-600 hover:text-[var(--brand-gold)] transition duration-300">مشاهده پنل</a>
                <a href="<?php echo e(route('quiz')); ?>" class="text-gray-600 hover:text-[var(--brand-gold)] transition duration-300">نمونه آزمون</a>
        ...
        <div class="flex items-center">
            ...
            <div class="hidden md:flex items-center space-x-4 space-x-reverse">
                <a href="<?php echo e(route('login')); ?>" class="text-gray-700 font-semibold hover:text-[var(--brand-gold)] transition duration-300">ورود</a>
                <a href="<?php echo e(route('register')); ?>" class="bg-[var(--brand-gold)] text-white font-bold py-2 px-5 rounded-lg hover:brightness-95 transition duration-300 shadow-md">ثبت نام</a>
            </div>
            <!-- Mobile Menu Button -->
    ...
    <section id="slider" class="relative w-full h-96 md:h-[500px] swiper-container">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <img src="http://127.0.0.1:8000/storage/posts/cE6uBFEgu04dfR0qJ0XMJQ66DFzRN43I8YE87Xhw.jpg" class="w-full h-full object-cover">
    ...
    <section id="blog" class="py-16 sm:py-24 bg-white">
        <div class="container max-w-screen-xl mx-auto px-6">
                ...
                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($index==0): ?>
                        <a href="#" class="lg:col-span-4 lg:order-1 bg-white rounded-2xl shadow-xl overflow-hidden h-full flex flex-col group transform hover:-translate-y-1 transition-all duration-300">
                            <div class="relative">
                                <img src="<?php echo e(Storage::url($post->image)); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-96 object-cover">
                                <div class="absolute top-4 right-4 bg-[var(--brand-gold)] text-white text-sm font-bold py-1 px-3 rounded-full shadow"><?php echo e($post->category->name); ?></div>
                            </div>
                            <div class="p-6 flex-grow flex flex-col">
                                <h3 class="text-2xl font-bold text-gray-800 mb-3 group-hover:text-[var(--brand-gold)] transition"><?php echo e($post->title); ?></h3>
                                <p class="text-gray-600 mb-4 flex-grow"><?php echo e($post->excerpt); ?></p>
                                <div class="pt-4 flex justify-between items-center text-sm text-gray-500 border-t border-gray-200 mt-auto">
                                    <span><i class="fas fa-user ml-2"></i><?php echo e($post->author->name); ?></span>
                                    <span><i class="fas fa-calendar-alt ml-2"></i><?php echo e(jdate($post->created_at)->format('j F Y')); ?></span>
                                </div>
                            </div>
                        </a>
                    <?php elseif($index==1): ?>
                    <div class="lg:col-span-2 lg:order-2 space-y-8">
                        <a href="#" class="bg-white rounded-2xl shadow-lg overflow-hidden block group transform hover:-translate-y-1 transition-all duration-300">
                            <div class="relative">
                                <img src="<?php echo e(Storage::url($post->image)); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-48 object-cover">
                                <div class="absolute top-3 right-3 bg-[var(--brand-gold)] text-white text-xs font-bold py-1 px-2.5 rounded-full shadow"><?php echo e($post->category->name); ?></div>
                            </div>
                            <div class="p-4">
                                <h4 class="font-bold text-lg text-gray-800 mb-3 group-hover:text-[var(--brand-gold)] transition"><?php echo e($post->title); ?></h4>
                                <p class="text-gray-600 mb-4 flex-grow"><?php echo e($post->excerpt); ?></p>
                                <div class="pt-4 flex justify-between items-center text-sm text-gray-500 border-t border-gray-200 mt-auto">
                                    <span><i class="fas fa-user ml-2"></i><?php echo e($post->author->name); ?></span>
                                    <span><i class="fas fa-calendar-alt ml-2"></i><?php echo e(jdate($post->created_at)->format('j F Y')); ?></span>
                        ...
                        <?php if(count($posts) == 2): ?></div><?php endif; ?>
                    <?php elseif($index==2): ?>
                        <a href="#" class="bg-white rounded-2xl shadow-lg overflow-hidden block group transform hover:-translate-y-1 transition-all duration-300">
                            <div class="relative">
                                <img src="<?php echo e(Storage::url($post->image)); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-48 object-cover">
                    ...
                    <?php elseif($index==3 || $index==4): ?>
                        <a href="#" class="lg:col-span-3 lg:order-3 bg-white rounded-2xl shadow-lg overflow-hidden block group transform hover:-translate-y-1 transition-all duration-300">
                            <div class="relative">
                                <img src="<?php echo e(Storage::url($post->image)); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-64 object-cover">
                                <div class="absolute top-3 right-3 bg-[var(--brand-gold)] text-white text-xs font-bold py-1 px-2.5 rounded-full shadow"><?php echo e($post->category->name); ?></div>
                            </div>
                            <div class="p-4">
                                <h4 class="font-bold text-lg text-gray-800 mb-3 group-hover:text-[var(--brand-gold)] transition"><?php echo e($post->title); ?></h4>
            ...
            <div class="text-center mt-12">
                <a href="<?php echo e(route('post.list')); ?>" class="inline-block font-bold py-3 px-8 rounded-lg hover:translate-y-1 transition duration-300 text-lg">
                    مشاهده بیشتر
                </a>
            </div>
        </div>
...
<?php /**PATH D:\programming projects\laravel\negarestan\resources\views/index.blade.php ENDPATH**/ ?>