...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="<?php echo e(route('quiz.addQuestion', $quiz->id)); ?>" class="bg-[var(--brand-gold)] text-white font-bold py-2 px-5 rounded-lg hover:brightness-95 transition duration-300 shadow-md flex items-center">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="p-4">
                                            <a href="<?php echo e(route('quiz.option', ['quiz'=>$quiz->id,'question'=>$question->id])); ?>" class="text-[var(--brand-blue)] hover:text-blue-500 ml-4"><i class="fas fa-eye"></i></a>
                                            <a href="<?php echo e(route('quiz.editQuestion', ['quiz'=>$quiz->id,'question'=>$question->id])); ?>" class="text-[var(--brand-blue)] hover:text-blue-500 ml-4"><i class="fas fa-edit"></i></a>
                                            <a href="<?php echo e(route('quiz.deleteQuestion', ['quiz'=>$quiz->id,'question'=>$question->id])); ?>" class="text-[var(--brand-blue)] hover:text-blue-500 delete-link" data-item-title="<?php echo e($question->text); ?>"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
